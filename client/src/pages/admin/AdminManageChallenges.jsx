...
const AdminManageChallenges = () => {
  ...
  return (
    <div className="admin-manage-challenges-page">
      <h2 className="admin-manage-challenges-title">Manage Challenges</h2>
      ...
      {filteredChallenges.length === 0 && (
        <p className="admin-manage-challenges-empty">No challenges found</p>
      )}

      <div className="admin-manage-challenges-grid">
        {filteredChallenges.map((ch) => (
          <div key={ch._id} className="admin-manage-challenges-card">
            <h3>{ch.title}</h3>
            ...
            <p>Participants: {ch.participantsCount}</p>

            <p>Created: {new Date(ch.createdAt).toLocaleDateString()}</p>

            {/* NEW OVERVIEW BUTTON */}
            <button
              className="admin-manage-challenges-overview"
              onClick={() => navigate(`/admin/challenges/${ch._id}/overview`)}
            >
              Overview
            </button>
